...
class PixelToCoord:
    def __init__(self):
        ...
        self.sub = rospy.Subscriber(
            '/pixel_and_depth', PixelsAndDepth, self.convertPixelsToCoordinates)
        self.sub_info = rospy.Subscriber(
            '/camera/depth/camera_info', CameraInfo, self.imageDepthInfoCallback)
